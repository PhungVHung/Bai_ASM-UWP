...
namespace hungdz.views
{
    ...
    /// </summary>
    public sealed partial class dk : Page
    {
        member hhh = new member();
        ...
        {
            this.hhh.email = this.t_email.Text;
            this.hhh.password = this.t_password.Password;
            this.hhh.firstName = this.t_firstname.Text;
            this.hhh.lastName = this.t_lastname.Text;
            this.hhh.address = this.t_address.Text;
            this.hhh.introduction = this.t_introduction.Text;
            this.hhh.phone = this.t_phone.Text;
            this.hhh.avatar = this.UrlImage.Text;

            HttpClient http = new HttpClient();
            var kien0 = new StringContent(JsonConvert.SerializeObject(hhh), System.Text.Encoding.UTF8, "application/json");
        ...
        private void radio_checked(object sender, RoutedEventArgs e)
        {
            ...
            this.hhh.gender = Int32.Parse(radio.Tag.ToString());
        }
